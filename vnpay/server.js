...
app.get("/payment", (req, res) => {
  ...
  // Lấy số tiền và phí vận chuyển từ query parameters, nếu không có sẽ lấy mặc định
  ...
  const vnpUrl = vnpay.buildPaymentUrl({
    vnp_Amount: totalAmount, // Số tiền thanh toán bao gồm phí vận chuyển
    vnp_IpAddr: ipAddr,
    vnp_TxnRef: Date.now(),
    vnp_OrderInfo: `Thanh toan don hang DEMO (Gom ${shipping}d ship)`,
